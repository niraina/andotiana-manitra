...
export const Header = () => {
    ...
    const menuItems = [
        { name: t('skills'), href: '#link' },
        { name: t('contact'), href: '#link' },
                    ...
                    <div className="relative flex flex-wrap items-center justify-between gap-6 lg:gap-0 py-2">
                        <div className="flex w-full justify-between lg:w-auto">
                            <Link
                             ...
                             <p className='font-semibold text-xl tracking-tighter uppercase'>Andotiana</p>  
                            </Link>
                            ...
                            <ul className="flex gap-8 text-sm">
                                {menuItems.map((item, index) => (
                                    <li key={index}>
                                        <Link
                                            href={item.href}
                                            className="text-black dark:text-white hover:underline block duration-150">
                                            <span>{item.name}</span>
                                        </Link>
                                    </li>
                                ))}
