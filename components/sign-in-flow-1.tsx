                ...
                {step === "email" ? (
                  ...
                  >
                    <div className="space-y-1">
                      <h1 className="text-[2.5rem] font-bold leading-[1.1] tracking-tight text-white">Andotiana Manitra</h1>
                      <p className="text-[1.8rem] text-white/70 font-light">{t('description')}</p>
                    </div>
                    
                    
                    <div className="space-y-4 flex items-center gap-3 justify-center">
                      <Link href="#" target="_blank" className="mb-0">
